...
// ── Re-exported from katgpt-core ─────────────────────────────────
// Substrate types consolidated into katgpt-core to eliminate duplication:
// - traits (Plan 107 Phase 0): ConstraintPruner, ScreeningPruner, companions
// - speculative substrate (Plan 008 Phase 2.5, 2026-06-28): TreeNode,
//   DraftResult, RejectionReason, DraftEvent, PrefillMode, FlashPrefillConfig,
//   BlockScores. katgpt-core's versions are supersets (additive feature-gated
//   fields/variants); re-export gives riir-engine access to the same surface.
...
// Substrate types RejectionReason, DraftEvent, PrefillMode, FlashPrefillConfig,
// and BlockScores are re-exported from katgpt-core (see top of file). Their
// definitions were bit-identical subsets of the katgpt-core versions (which
// carry additive feature-gated fields/variants like KurtosisRejection,
// score_reduction, budget_adaptation).
